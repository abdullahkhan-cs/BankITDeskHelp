...
{
    /// <inheritdoc />
    public partial class AddComplaintDomainModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedManagerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_AssignedManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplaintHistories_AspNetUsers_PerformedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintHistories_PerformedByUserId",
                table: "ComplaintHistories",
                column: "PerformedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Complaints_AssignedManagerId",
                table: "Complaints",
